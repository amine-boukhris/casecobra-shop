    ...
    return (
        <div className="bg-slate-50">
                ...
                <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
                    <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
                        <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                            ...
                            <p className="mt-8 text-lg lg:pr-10 max-w-prose text-cener lg:text-left text-balance md:text-wrap">
            ...
            <section className="bg-slate-100 py-24">
                <MaxWidthWrapper className="flex flex-col items-cetner gap-16 sm:gap-32">
                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
                        <div className="flex flex-auto flex-col gap-4 lg:pr-8 l:pr-20">
                            ...
                            <div className="text-lg leading-8">
                                <p>
                                    ...
                                    two and a half months now and the{' '}
                                    <span className="p-0.5 bg-slate-800 text-white">
                                        the image is super clear
                                    </span>
                                    , on the case I had before, the image
                                    started fading into yellowish color after a
                        ...
                        <div className="flex flex-auto flex-col gap-4 lg:pr-8 l:pr-20">
                            ...
                            <div className="text-lg leading-8">
                                <p>
                                    ...
                                    pretty heavy stretch marks on all of my last
                ...
                <MaxWidthWrapper className="py-24">
                    ...
                    <div className="mx-auto max-w-6xl px-6 lg:px-8">
                        <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
                            ...
                            <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                                <img
                                    src="/horse.jpg"
                                    className="rounded-md objct-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full"
                                />
                            </div>
                    ...
                    <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
                        ...
                        <div className="flex justify-center">
                            ...
                            >
                                Create your case now <ArrowRight className="" />
                            </Link>
                        </div>
                    </ul>
                </MaxWidthWrapper>
