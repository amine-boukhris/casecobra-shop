...
import { Radio, RadioGroup, Description as RadioGroupDescription, Label as RadioGroupLabel } from '@headlessui/react'
// Icons
...
const DesignConfigurator = ({ configId, imageUrl, imageDimensions }: DesignConfiguratorProps) => {
  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        title: 'Something went wrong',
        description: 'There was a proble saving your config, please try again.',
        variant: 'destructive',
      })
    }
  }
                    ...
                    {COLORS.map((color) => (
                      <Radio
                        ...
                        className={({ checked, focus }) =>
                          cn(
                            'realtive -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none border-2 border-transparent',
                            {
                      ...
                      >
                        <span
                          className={cn(`bg-${color.tw}`, 'size-8 rounded-full border border-black border-opacity-10')}
                        />
                      </Radio>
                    ))}
                  </div>
                        ...
                        >
                          <span className="flex items-center">
                            <span className="flex flex-col text-sm">
                              ...
                              {option.description ? (
                                <RadioGroupDescription as="span" className="text-gray-400">
